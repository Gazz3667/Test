...
-- Tạo nội dung codebox đầy đủ = GenScript + Function Info tự động
...
newButton("Run Code", function()
	...
	if succeeded then TextLabel.Text = "Chạy thành công!"
	else TextLabel.Text = "Lỗi khi chạy code!" end
end)
